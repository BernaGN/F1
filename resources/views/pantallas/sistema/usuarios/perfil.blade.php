...
@section('content')
    <form action="{{ route('perfil.update', $usuario->slug) }}" method="POST" id="formulario" autocomplete="off">
        @csrf
        @method('PUT')
                ...
                <div class="col-md-8">
                    <div class="p-3 py-5">
                        ...
                        <div class="box-footer mt20">
                            <button type="button" class="btn btn-primary mt-2" role="dialog" data-bs-toggle="modal"
        ...
        <div class="container rounded bg-white mt-5">
            <div class="col-md-8">
                <div class="p-3 py-5">
                    ...
                    <div class="box-footer mt20">
                        <button type="button" class="btn btn-primary mt-2" role="dialog" data-bs-toggle="modal"
                            data-bs-target="#confirm-contraseña">
                            Guardar
                        </button>
                    </div>
                </div>
